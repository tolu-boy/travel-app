...
//       <Button className="mt-2 bg-[#0054E4] text-white font-medium px-8 py-4 rounded-sm" onClick={onClick}>
//         {buttonText}
//       </Button>
//     </div>
//   );
  ...
  return (
    <div className={`flex flex-col items-center justify-center py-10 px-8 bg-white rounded-sm ${className}`}>
      ...
      <Button
        ...
        onClick={onClick} // <-- CLICK HANDLER NOW WORKS
      >
        {buttonText}
      </Button>
    </div>
